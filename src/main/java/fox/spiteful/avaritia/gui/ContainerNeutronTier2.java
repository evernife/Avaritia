...
public class ContainerNeutronTier2 extends Container {
    private TileEntityNeutronTier2 tileNeutron;

    public ContainerNeutronTier2(InventoryPlayer player, TileEntityNeutronTier2 machine)
    {
