...
public class ContainerStarCondenserTier2 extends Container {

    private TileEntityStarCondenserTier2 machine;

    public ContainerStarCondenserTier2(InventoryPlayer player, TileEntityStarCondenserTier2 tileEntityStarCondenserTier2)
    {
        this.machine = tileEntityStarCondenserTier2;
        this.addSlotToContainer(new SlotFurnace(player.player, machine, 2, 80, 35){
            @Override
            public boolean isItemValid(ItemStack itemStack) {
                return ContainerStarCondenserTier2.this.machine.isItemValidForSlot(0, itemStack);
            }
        });
        int i;
