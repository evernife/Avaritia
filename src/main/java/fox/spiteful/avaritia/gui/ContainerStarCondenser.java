...
public class ContainerStarCondenser extends Container {

    private TileEntityStarCondenser machine;

    public ContainerStarCondenser(InventoryPlayer player, TileEntityStarCondenser tileEntityStarCondenser)
    {
        this.machine = tileEntityStarCondenser;
        this.addSlotToContainer(new SlotFurnace(player.player, machine, 2, 80, 35){
            @Override
            public boolean isItemValid(ItemStack itemStack) {
                return ContainerStarCondenser.this.machine.isItemValidForSlot(0, itemStack);
            }
        });
        int i;
