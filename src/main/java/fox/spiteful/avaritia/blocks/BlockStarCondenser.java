...
public class BlockStarCondenser extends BlockContainer {

    private IIcon top, sides, front;
    private Random randy = new Random();

    public BlockStarCondenser(){
        super(Material.iron);
    ...
    {
        this.top = iconRegister.registerIcon("avaritia:star_condenser_top");
        this.sides = iconRegister.registerIcon("avaritia:star_condenser_side");
        this.front = iconRegister.registerIcon("avaritia:star_condenser_front");
    }
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side){
        if(side == 1)
            return top;
        int facing = 2;
        TileEntityStarCondenser machine = (TileEntityStarCondenser)world.getTileEntity(x, y, z);
        if(machine != null)
    ...
    public boolean onBlockActivated (World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        {
            player.openGui(Avaritia.instance, 6, world, x, y, z);
            return true;
        }
    }
    ...
    {
        return new TileEntityStarCondenser();
    }

    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
    {
        TileEntity tile = world.getTileEntity(x, y, z);
        if(tile instanceof TileEntityStarCondenser) {
            TileEntityStarCondenser machine = (TileEntityStarCondenser)tile;
    ...
    {
        TileEntityStarCondenser collector = (TileEntityStarCondenser)world.getTileEntity(x, y, z);
